...
function ProceduralQuantumEngine() {
  ...
  useFrame((state, delta) => {
    ...
    if (innerRef.current) {
      ...
      const s = 0.5 + Math.sin(state.clock.elapsedTime * 2.5) * 0.035;
